  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative glass-strong rounded-3xl px-8 py-14 sm:px-14 text-center glow-accent overflow-hidden">
          <div className="absolute inset-0 bg-glow-accent opacity-25 pointer-events-none" />

          <h2 className="relative font-heading font-extrabold text-white text-2xl sm:text-3xl lg:text-4xl leading-tight mb-4">
            ¿Listo para escalar tu negocio
            {" "}<span className="text-gradient-accent">con inteligencia artificial?</span>
          </h2>
          <p className="relative text-white/50 text-base max-w-xl mx-auto mb-8">
